...
class Scene:
    def __init__(self, rootParent=None):
        ...
        self.ground = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Ground.bam')
        ...
        self.Army = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Army.bam')
        ...
        self.factory1 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Factory.bam')
        ...
        self.factory2 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Factory.bam')
        ...
        self.livingQuarters1 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/LivingQuarters.bam')
        ...
        self.livingQuarters2 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/LivingQuarters.bam')
        ...
        self.livingQuarters5 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/LivingQuarters.bam')
        ...
        self.livingQuarters4 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/LivingQuarters.bam')
        ...
        self.livingQuarters3 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/LivingQuarters.bam')
        ...
        self.mine1 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Mine.bam')
        ...
        self.mine2 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Mine.bam')
        ...
        self.tower1 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Tower.bam')
        ...
        self.tower2 = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Tower.bam')
        ...
        self.shield = loader.load_model('/home/fireclaw/workspace/pyweeks/pyweek34/Project/outward/assets/Shield.bam')
        ...
        light = DirectionalLight('DirectionalLight_1')
        self.DirectionalLight_1 = rootParent.attachNewNode(light)
        self.DirectionalLight_1.set_pos(LPoint3f(-99.1269, -95.1613, 41.9214))
        self.DirectionalLight_1.set_hpr(LVecBase3f(327.706, -32.9727, -44.5136))
        self.DirectionalLight_1.set_scale(LVecBase3f(1, 1, 1))
        rootParent.setLight(self.DirectionalLight_1)
